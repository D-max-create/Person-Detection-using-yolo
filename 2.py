...
def main():
    ...
    for frame in frame_generator:
        ...
        rtl_color = (0, 0, 255) if chan9 > 1500 else (0, 255, 0)  # Red for ON, Green for OFF
        
        # Put RTL status text on the frame
        cv2.putText(frame, f"RTL Status: {rtl_status}", (20, 40), 
                   cv2.FONT_HERSHEY_SIMPLEX, 1, rtl_color, 2)
        
        # Also display the actual channel 9 value for debugging
