...
pid_roll_left = PID(Kp=0.09, Ki=0.08, Kd=0.04, setpoint=0)  
...
# Set output limits
pid_roll_left.output_limits = (-300, -100)
pid_roll_center.output_limits = (-100, 100)
pid_roll_right.output_limits = (100, 300)
